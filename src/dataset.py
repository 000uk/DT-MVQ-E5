...
def get_loader(data_path, batch_size, tokenizer):
	dataset = BookDataset(data_path, tokenizer)
	...
	train_loader = DataLoader(
		train_dataset, batch_size=batch_size, shuffle=True, collate_fn=dataset.collate_fn
	)

	valid_loader = DataLoader(
		valid_dataset, batch_size=batch_size, shuffle=False, collate_fn=dataset.collate_fn
	)
